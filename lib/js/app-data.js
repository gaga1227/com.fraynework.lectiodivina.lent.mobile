...
window.App = (function(app){
	...
	App.data = {
		...
		//section titles
		sections: [ 
			{ sec:'Week 1', 		title:'In the Desert' },
			{ sec:'Weeks 2-3', 		title:'The Gift of Living Water' },
			{ sec:'Weeks 4-5', 		title:'Children of the Light' },
			{ sec:'Passion Sunday', title:'Take up your Cross' },
			{ sec:'Easter Triduum', title:'Drawn into Joy' },
		],
